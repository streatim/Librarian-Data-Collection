<?php //Set basic functions and values that are important to the page.
include('functions.php'); //Functions script included in the repo.

//Uncomment lines 5-7 after revising them to gather the information you want using your systems.
...
<script type="text/javascript">
	...
	<form name="courseInfoForm" method="POST" target="_self">
		...
		<input type="hidden" id="update" name="update" value="<?php if(isset($_GET['courseID'])){echo $courseID;}else{echo 'FALSE';} ?>">
		<div class="large-12 columns">		
			...
			<div class="large-4 columns">
				...
				<input type="number" id="studentNum" name="studentNum" min="0" <?php if(isset($formValue)){echo 'value="'.$formValue['Students'].'" ';} ?>>
			</div>
			<div class="large-4 columns">
			...
			<div class="large-4 columns">
				...
				<?php 	foreach($assessTypes as $key=>$assess){
							echo '<div><input type="checkbox" value="'.$key.'" id="'.$assess.'" name="assessmentLevel[]"';
		...
		<div class="large-12 columns">
			...
			<?php
				$i=0;
				$activityDivCheck = (count2($activities)/2)-1;
				foreach($activities as $key=>$activity){
					if($i>$activityDivCheck){echo '</div><div class="large-6 columns">'; $activityDivCheck = count2($activities);}
